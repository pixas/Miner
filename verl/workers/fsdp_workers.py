...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def compute_log_prob(self, data: DataProto):
        ...
        hidden_state_config = data.meta_info.pop("hidden_state_config", None)
        ...
        with self.ulysses_sharding_manager:
            with adapter_ctx:
                output, entropys, hidden_states = self.actor.compute_log_prob(data=data, calculate_entropy=True, config=hidden_state_config)
            if hidden_states is not None:
                output = DataProto.from_dict(
                    tensors={"old_log_probs": output, "entropys": entropys, "response_emb": hidden_states},
    ...
    def compute_ref_log_prob(self, data: DataProto):
        ...
        with self.ulysses_sharding_manager:
            ...
            output, _, _ = self.ref_policy.compute_log_prob(data=data, config=None)
